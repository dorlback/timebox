...
export default function DarkModeToggle() {
  ...
  return (
    <button
      onClick={toggleDark}
      className="rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
