      ...
      <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col md:flex-row gap-8 p-4 sm:p-6 lg:p-8 pb-32 md:pb-8">
        ...
        <main className="flex-1">
          <article className="prose prose-neutral dark:prose-invert max-w-none bg-card p-6 sm:p-12 rounded-2xl border border-border shadow-sm">
            <h1 className="text-2xl sm:text-3xl font-bold mb-8 text-card-foreground">{t('legal.termsOfService.title')}</h1>
            ...
            <div className="space-y-12">
              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  ...
                  {t('legal.termsOfService.s1.title')}
                </h2>
                <p>{t('legal.termsOfService.s1.c1')}</p>
              </section>

              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  <span className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center text-sm">02</span>
                  {t('legal.termsOfService.s2.title')}
                </h2>
                <ul className="list-disc ml-5 space-y-2">
                  <li>{t('legal.termsOfService.s2.i1')}</li>
                  <li>{t('legal.termsOfService.s2.i2')}</li>
                  <li>{t('legal.termsOfService.s2.i3')}</li>
                </ul>
              </section>
              ...
              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  ...
                  {t('legal.termsOfService.s3.title')}
                </h2>
                <ul className="list-disc ml-5 space-y-2">
                  <li>{t('legal.termsOfService.s3.i1')}</li>
                  <li>{t('legal.termsOfService.s3.i2')}</li>
                </ul>
              </section>
              ...
              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  ...
                  {t('legal.termsOfService.s4.title')}
                </h2>
                <ul className="list-disc ml-5 space-y-2">
                  <li>{t('legal.termsOfService.s4.i1')}</li>
                  <li>{t('legal.termsOfService.s4.i2')}</li>
                  <li>{t('legal.termsOfService.s4.i3')}</li>
                </ul>
              </section>
              ...
              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  ...
                  {t('legal.termsOfService.s5.title')}
                </h2>
                <ul className="list-disc ml-5 space-y-2">
                  <li>{t('legal.termsOfService.s5.i1')}</li>
                  <li>{t('legal.termsOfService.s5.i2')}</li>
                  <li>{t('legal.termsOfService.s5.i3')}</li>
                </ul>
              </section>
              ...
              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  ...
                  {t('legal.termsOfService.s6.title')}
                </h2>
                <p>{t('legal.termsOfService.s6.c1')}</p>
                <ul className="list-disc ml-5 space-y-2">
                  <li>{t('legal.termsOfService.s6.i1')}</li>
                  <li>{t('legal.termsOfService.s6.i2')}</li>
                  <li>{t('legal.termsOfService.s6.i3')}</li>
                </ul>
              </section>
              ...
              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  ...
                  {t('legal.termsOfService.s7.title')}
                </h2>
                <ul className="list-disc ml-5 space-y-2">
                  <li>{t('legal.termsOfService.s7.i1')}</li>
                  <li>{t('legal.termsOfService.s7.i2')}</li>
                </ul>
              </section>
              ...
              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  ...
                  {t('legal.termsOfService.s8.title')}
                </h2>
                <ul className="list-disc ml-5 space-y-2">
                  <li>{t('legal.termsOfService.s8.i1')}</li>
                  <li>{t('legal.termsOfService.s8.i2')}</li>
                  <li>{t('legal.termsOfService.s8.i3')}</li>
                </ul>
              </section>

              <section className="font-serif leading-relaxed space-y-4 text-muted-foreground">
                <h2 className="text-xl font-bold text-card-foreground flex items-center gap-2">
                  <span className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center text-sm">09</span>
                  {t('legal.termsOfService.s9.title')}
                </h2>
                <p>{t('legal.termsOfService.s9.c1')}</p>
              </section>
            </div>
          </article>
        </main>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-background/90 backdrop-blur-lg border-t border-border z-40 pb-safe">
        <div className="flex items-center justify-around h-16">
          ...
          >
            ...
            <span className="text-[10px] font-bold">{t('legal.terms')}</span>
          </Link>
          <Link
            href="/privacy"
          ...
          >
            ...
            <span className="text-[10px] font-medium">{t('legal.privacy')}</span>
          </Link>
        </div>
      </nav>
    </div>
