      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto w-full p-4 sm:p-8 lg:p-12 pb-20 md:pb-12">
          <div className="max-w-4xl mx-auto space-y-8">
            {/* Profile Header */}
            <header className="bg-card rounded-xl p-4 md:p-8 border border-border flex flex-col md:flex-row items-center gap-4 md:gap-8 shadow-sm transition-colors">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex flex-col md:flex-row items-center gap-2 md:gap-3 mb-2">
                  <h1 className="text-xl md:text-3xl font-bold tracking-tight text-card-foreground">Alex Johnson</h1>
